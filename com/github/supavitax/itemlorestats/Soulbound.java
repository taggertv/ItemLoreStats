...
/*  28: 23 */       this.PlayerDataConfig.load(new File(ItemLoreStats.plugin.getDataFolder() + File.separator + "language.yml"));
/*  29:    */       
...
/*  49: 42 */           (Soulbound.this.gearStats.getSoulboundNameHead(playerFinal) != null) && 
/*  50: 43 */           (!Soulbound.this.gearStats.getSoulboundNameHead(playerFinal).equals(playerFinal.getName())))
/*  51:    */         {
/*  52: 44 */           int i = 36;
...
/*  61: 54 */             playerFinal.sendMessage(Soulbound.this.getResponse("SoulboundMessages.InventoryFull.Head") + " " + Soulbound.this.gearStats.getSoulboundNameHead(playerFinal) + ".");
...
/*  67: 58 */             playerFinal.sendMessage(Soulbound.this.getResponse("SoulboundMessages.BoundToSomeoneElse.Head") + " " + Soulbound.this.gearStats.getSoulboundNameHead(playerFinal) + ".");
...
/*  74:    */   }
/*  75:    */   
/*  76:    */   public void checkSoulboundChest(Player player)
/*  77:    */   {
...
/*  85: 78 */           (Soulbound.this.gearStats.getSoulboundNameChest(playerFinal) != null) && 
/*  86: 79 */           (!Soulbound.this.gearStats.getSoulboundNameChest(playerFinal).equals(playerFinal.getName())))
/*  87:    */         {
/*  88: 80 */           int i = 36;
...
/*  97: 90 */             playerFinal.sendMessage(Soulbound.this.getResponse("SoulboundMessages.InventoryFull.Chest") + " " + Soulbound.this.gearStats.getSoulboundNameChest(playerFinal) + ".");
...
/* 103: 94 */             playerFinal.sendMessage(Soulbound.this.getResponse("SoulboundMessages.BoundToSomeoneElse.Chest") + " " + Soulbound.this.gearStats.getSoulboundNameChest(playerFinal) + ".");
...
/* 110:    */   }
/* 111:    */   
/* 112:    */   public void checkSoulboundLegs(Player player)
/* 113:    */   {
...
/* 121:114 */           (Soulbound.this.gearStats.getSoulboundNameLegs(playerFinal) != null) && 
/* 122:115 */           (!Soulbound.this.gearStats.getSoulboundNameLegs(playerFinal).equals(playerFinal.getName())))
/* 123:    */         {
/* 124:116 */           int i = 36;
...
/* 133:126 */             playerFinal.sendMessage(Soulbound.this.getResponse("SoulboundMessages.InventoryFull.Legs") + " " + Soulbound.this.gearStats.getSoulboundNameLegs(playerFinal) + ".");
...
/* 139:130 */             playerFinal.sendMessage(Soulbound.this.getResponse("SoulboundMessages.BoundToSomeoneElse.Legs") + " " + Soulbound.this.gearStats.getSoulboundNameLegs(playerFinal) + ".");
...
/* 146:    */   }
/* 147:    */   
/* 148:    */   public void checkSoulboundBoots(Player player)
/* 149:    */   {
...
/* 157:150 */           (Soulbound.this.gearStats.getSoulboundNameBoots(playerFinal) != null) && 
/* 158:151 */           (!Soulbound.this.gearStats.getSoulboundNameBoots(playerFinal).equals(playerFinal.getName())))
/* 159:    */         {
/* 160:152 */           int i = 36;
...
/* 169:162 */             playerFinal.sendMessage(Soulbound.this.getResponse("SoulboundMessages.InventoryFull.Boots") + " " + Soulbound.this.gearStats.getSoulboundNameBoots(playerFinal) + ".");
...
/* 175:166 */             playerFinal.sendMessage(Soulbound.this.getResponse("SoulboundMessages.BoundToSomeoneElse.Boots") + " " + Soulbound.this.gearStats.getSoulboundNameBoots(playerFinal) + ".");
...
/* 182:    */   }
/* 183:    */   
/* 184:    */   public void checkSoulboundItemInHand(Player player)
/* 185:    */   {
...
/* 193:186 */           (Soulbound.this.gearStats.getSoulboundNameItemInHand(playerFinal) != null) && 
/* 194:187 */           (!Soulbound.this.gearStats.getSoulboundNameItemInHand(playerFinal).equals(playerFinal.getName())))
/* 195:    */         {
/* 196:188 */           int i = 36;
...
/* 205:198 */             playerFinal.sendMessage(Soulbound.this.getResponse("SoulboundMessages.InventoryFull.ItemInHand") + " " + Soulbound.this.gearStats.getSoulboundNameItemInHand(playerFinal) + ".");
...
/* 211:202 */             playerFinal.sendMessage(Soulbound.this.getResponse("SoulboundMessages.BoundToSomeoneElse.ItemInHand") + " " + Soulbound.this.gearStats.getSoulboundNameItemInHand(playerFinal) + ".");
